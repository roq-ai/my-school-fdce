  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to My School - Streamlining School Management for Enhanced Efficiency and Improved Educational Outcomes."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzY2hvb2x8ZW58MHx8fHwxNjkwODMxMDE4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to My School - Streamlining School Management for Enhanced Efficiency and Improved Educational Outcomes.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                ...
                <Card userTypeName="Parent" type="parent" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>

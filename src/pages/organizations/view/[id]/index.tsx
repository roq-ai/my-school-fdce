...
import { getParents, deleteParentById, createParent } from 'apiSdk/parents';
import { getStaffMembers, deleteStaffMemberById, createStaffMember } from 'apiSdk/staff-members';
import { getTeachers, deleteTeacherById, createTeacher } from 'apiSdk/teachers';
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6}>
              <UserPageTable
                createHandler={createParent}
                deleteHandler={deleteParentById}
                fetcher={getParents}
                entity="parent"
                title="Parents"
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6}>
              <UserPageTable
                createHandler={createStaffMember}
                deleteHandler={deleteStaffMemberById}
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6}>
              <UserPageTable
                createHandler={createTeacher}
                deleteHandler={deleteTeacherById}
                fetcher={getTeachers}
                entity="teacher"
                title="Teachers"
                filters={{ organization_id: id }}
